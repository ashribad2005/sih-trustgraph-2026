...
class DashboardTests(APITestCase):
    ...
    def test_dashboard_metrics(self):
        ...
        data = response.data
        self.assertEqual(data['total_monitored_volume_inr'], 8000.00) # 1000 + 5000 + 2000
        self.assertEqual(data['active_high_risk_cases'], 1) # Only case1 is OPEN
        self.assertEqual(data['total_screened_transactions'], 3)
        self.assertEqual(data['network_interception_rate'], 0.0) # No blockchain anchored cases
